    ...
    <main className="flex flex-col h-screen bg-[#0d1117] text-[#c9d1d9] overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 border-r border-[#30363d] flex flex-col bg-[#0d1117]">
           <div className="flex items-center justify-between px-4 h-12 bg-[#010409] border-b border-[#30363d]">
               <div className="flex gap-3 items-center">
                  <FileCode size={16} className="text-[#2f81f7]" />
                  <h2 className="text-xs font-bold text-[#c9d1d9] uppercase tracking-tighter">Qiskit Code Editor</h2>
               </div>
               <button 
                 onClick={runCode}
                 disabled={loading}
                 className="flex items-center gap-2 px-4 py-1.5 bg-[#238636] hover:bg-[#2ea043] text-white text-xs font-bold rounded-md transition-all active:scale-95 disabled:opacity-50"
               >
        ...
        {/* Output Console Side */}
        <div className="w-96 flex flex-col bg-[#010409] h-full shadow-2xl">
           <div className="flex items-center gap-3 px-4 h-12 bg-[#0d1117] border-b border-[#30363d]">
              <Terminal size={16} className="text-[#8b949e]" />
              <h3 className="text-xs font-bold text-[#8b949e] uppercase tracking-widest">Output</h3>
           </div>
           
           <div className="flex-1 p-6 font-mono text-[11px] overflow-auto text-[#7ee787] custom-scrollbar bg-[#0d1117]/50">
              {output ? (
